{ pkgs, ... }:
{
  ...
  programs.zsh = {
    ...
    dotDir = ".config/zsh";
    sessionVariables = {
      PATH="\${HOME}/bin:\${HOME}/.local/bin:\$HOME/.emacs.d/bin:\$HOME/.cabal/bin:\${PATH}";
      GIT_SSH_COMMAND="ssh -i \$HOME/.config/ssh/key -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no";
      EDITOR="nvim";
      VISUAL="emacs";
      BROWSER="firefox";
      LC_ALL="en_US.UTF-8";
    ...
    initExtra = ''
      ...
      source ~/.config/nixpkgs/term/zsh/p10k.zsh
